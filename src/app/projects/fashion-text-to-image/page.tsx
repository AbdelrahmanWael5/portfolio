      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-8 pb-24">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-6">
                    ...
                    <p className="mt-3 leading-7 text-gray-400">
                    The interaction begins with a natural language description of the
                    desired clothing item, allowing users to express their preferences
                    conversationally without prompt engineering.
                    </p>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-6">
                    ...
                    <p className="mt-3 leading-7 text-gray-400">
                    Guides the conversation, answers fashion-related questions, and
                    requests only the clothing attributes that are still missing.
                    </p>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-6">
                    ...
                    <p className="mt-3 leading-7 text-gray-400">
                    Extracts garment attributes from each user message and continuously
                    updates the structured clothing representation throughout the
                    conversation.
                    </p>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-6">
                    ...
                    <h3 className="text-lg font-semibold">
                    Structured Clothing Memory
                    </h3>

                    <p className="mt-3 leading-7 text-gray-400">
                    Maintains the confirmed garment attributes as a shared state,
                    enabling the agents to preserve context and support user
                    modifications without restarting the conversation.
                    </p>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-6">
                    ...
                    <p className="mt-3 leading-7 text-gray-400">
                    Converts the structured clothing representation into the
                    standardized prompt format expected by the fine-tuned Stable
                    Diffusion XL model.
                    </p>
                ...
                <div className="rounded-2xl border border-purple-500/20 bg-purple-500/10 p-6">
                    ...
                    <p className="mt-3 leading-7 text-gray-300">
                    The generated prompt is passed to the fine-tuned Stable Diffusion
                    XL model, producing a fashion image that closely matches the
        ...
        <section className="mx-auto max-w-7xl px-8 pb-24">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur">
                ...
                <div className="rounded-2xl border border-purple-500/20 bg-purple-500/10 p-6">
                    ...
                    <li>• Generated image-caption dataset from VITON-HD</li>

                    <li>• Fine-tuned only the denoising UNet</li>

                    <li>• Preserved pretrained latent representations</li>

                    <li>• Adapted SDXL to understand fashion-specific attributes</li>

                    <li>• Improved prompt adherence and image consistency</li>
        ...
        <section className="mx-auto max-w-7xl px-8 pb-24">
            ...
            pattern: "Solid"
                    ...
                    Once all required attributes are collected, this representation is
                    automatically converted into the structured prompt expected by the
                    fine-tuned Stable Diffusion XL model.
                    </p>
        ...
        <section className="mx-auto max-w-7xl px-8 pb-24">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                <h3 className="text-xl font-semibold">
                    Expanded Clothing Representation
                </h3>
